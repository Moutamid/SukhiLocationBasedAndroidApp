...
public class SetYourLocation extends AppCompatActivity {
    ...
    private String uId;
    private List<com.example.sukhilocationbasedapp.Model.Address> addressList = new ArrayList<>();
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < friends.length(); i++) {
                                ...
                                com.example.sukhilocationbasedapp.Model.Address model = new com.example.sukhilocationbasedapp.Model.Address();
